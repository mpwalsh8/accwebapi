...
class RostersControllerTest < ActionController::TestCase
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post :create, roster: { athlete_id: @roster.athlete_id, name: @roster.name, team_id: @roster.team_id }
    end
  ...
  test "should update roster" do
    patch :update, id: @roster, roster: { athlete_id: @roster.athlete_id, name: @roster.name, team_id: @roster.team_id }
    assert_redirected_to roster_path(assigns(:roster))
  end
