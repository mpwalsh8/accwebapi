...
class AthletesTeamsControllerTest < ActionController::TestCase
  ...
  test "should create athletes_team" do
    assert_difference('AthletesTeam.count') do
      post :create, athletes_team: { athlete_id: @athletes_team.athlete_id, captain: @athletes_team.captain, team_id: @athletes_team.team_id }
    end
  ...
  test "should update athletes_team" do
    patch :update, id: @athletes_team, athletes_team: { athlete_id: @athletes_team.athlete_id, captain: @athletes_team.captain, team_id: @athletes_team.team_id }
    assert_redirected_to athletes_team_path(assigns(:athletes_team))
  end
